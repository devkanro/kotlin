...
internal class FileClassLowering(
    ...
    private fun createFileClass(
        irFile: IrFile,
        fileClassMembers: List<IrDeclaration>,
    ): IrClass {
        ...
        return context.irFactory
            .createClass(
                ...
                name = Name.identifier(FileUtil.getNameWithoutExtension(irFile.path) + "Kt"),
