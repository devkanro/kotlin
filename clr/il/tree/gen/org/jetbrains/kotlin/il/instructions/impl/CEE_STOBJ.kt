...
object CEE_STOBJ : ILElementBase(), ILOpCode {
    override val label: String = "stobj"
    override val input: ILOpCodeInput = ILOpCodeInput.PopIPop1
    ...
    override val code: UShort = 0x81u
