...
object CEE_STIND_R8 : ILElementBase(), ILOpCode {
    override val label: String = "stind.r8"
    override val input: ILOpCodeInput = ILOpCodeInput.PopIPopR8
    ...
    override val code: UShort = 0x57u
