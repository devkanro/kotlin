...
import org.jetbrains.kotlin.il.declarations.ILAssemblyDecl
import org.jetbrains.kotlin.il.primitive.ILAsmDecl
import org.jetbrains.kotlin.il.primitive.ILDottedName

class ILAssemblyDeclImpl @ILImplementationDetail constructor(
    override var name: ILDottedName,
    override val decls: MutableList<ILAsmDecl>,
) : ILAssemblyDecl()
