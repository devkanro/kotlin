...
object CEE_STELEM_R4 : ILElementBase(), ILOpCode {
    override val label: String = "stelem.r4"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPopIPopR4
    ...
    override val code: UShort = 0xA0u
