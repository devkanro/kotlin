...
import org.jetbrains.kotlin.il.primitive.ILCallKind

class ILCallConvImpl @ILImplementationDetail constructor(
    override var isInstance: Boolean,
    override var isExplicit: Boolean,
    override var kind: ILCallKind,
) : ILCallConv()
