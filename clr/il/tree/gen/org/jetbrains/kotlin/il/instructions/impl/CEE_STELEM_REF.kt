...
object CEE_STELEM_REF : ILElementBase(), ILOpCode {
    override val label: String = "stelem.ref"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPopIPopRef
    ...
    override val code: UShort = 0xA2u
