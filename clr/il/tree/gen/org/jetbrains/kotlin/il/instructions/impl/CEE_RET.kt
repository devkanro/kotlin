...
object CEE_RET : ILElementBase(), ILOpCode {
    override val label: String = "ret"
    ...
    override val code: UShort = 0x2Au
    override val controlFlow: ILOpCodeControlFlow = ILOpCodeControlFlow.RETURN
}
