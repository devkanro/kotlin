...
object CEE_STIND_I8 : ILElementBase(), ILOpCode {
    override val label: String = "stind.i8"
    override val input: ILOpCodeInput = ILOpCodeInput.PopIPopI8
    ...
    override val code: UShort = 0x55u
