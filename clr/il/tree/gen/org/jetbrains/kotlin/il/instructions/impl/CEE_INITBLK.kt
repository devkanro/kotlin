...
object CEE_INITBLK : ILElementBase(), ILOpCode {
    override val label: String = "initblk"
    override val input: ILOpCodeInput = ILOpCodeInput.PopIPopIPopI
    ...
    override val code: UShort = 0xFE18u
