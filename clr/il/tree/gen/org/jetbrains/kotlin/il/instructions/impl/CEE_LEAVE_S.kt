...
object CEE_LEAVE_S : ILElementBase(), ILOpCode {
    override val label: String = "leave.s"
    ...
    override val code: UShort = 0xDEu
    override val controlFlow: ILOpCodeControlFlow = ILOpCodeControlFlow.BRANCH
}
