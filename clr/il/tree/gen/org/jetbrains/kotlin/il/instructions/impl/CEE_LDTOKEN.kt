...
object CEE_LDTOKEN : ILElementBase(), ILOpCode {
    override val label: String = "ldtoken"
    override val input: ILOpCodeInput = ILOpCodeInput.Pop0
    override val output: ILOpCodeOutput = ILOpCodeOutput.PushI
    override val param: ILOpCodeParam = ILOpCodeParam.InlineTok
    override val type: ILOpCodeType = ILOpCodeType.Primitive
    override val code: UShort = 0xD0u
