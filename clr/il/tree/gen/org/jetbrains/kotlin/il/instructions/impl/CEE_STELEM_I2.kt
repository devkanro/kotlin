...
object CEE_STELEM_I2 : ILElementBase(), ILOpCode {
    override val label: String = "stelem.i2"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPopIPopI
    ...
    override val code: UShort = 0x9Du
