...
import org.jetbrains.kotlin.il.ILCallKind
import org.jetbrains.kotlin.il.ILElement
import org.jetbrains.kotlin.il.ILElementBase

/**
 * Generated from: [org.jetbrains.kotlin.il.generator.ILTree.callConv]
 */
abstract class ILCallConv : ILElementBase(), ILElement {
    abstract val isInstance: Boolean
    abstract val isExplicit: Boolean
    abstract val kind: ILCallKind
}
