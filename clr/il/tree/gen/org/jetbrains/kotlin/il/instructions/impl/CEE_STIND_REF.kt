...
object CEE_STIND_REF : ILElementBase(), ILOpCode {
    override val label: String = "stind.ref"
    override val input: ILOpCodeInput = ILOpCodeInput.PopIPopI
    ...
    override val code: UShort = 0x51u
