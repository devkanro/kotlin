...
object CEE_BRFALSE : ILElementBase(), ILOpCode {
    override val label: String = "brfalse"
    override val input: ILOpCodeInput = ILOpCodeInput.PopI
    override val output: ILOpCodeOutput = ILOpCodeOutput.Push0
    override val param: ILOpCodeParam = ILOpCodeParam.InlineBrTarget
    override val type: ILOpCodeType = ILOpCodeType.Primitive
    override val code: UShort = 0x39u
