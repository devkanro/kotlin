...
/**
 * Generated from: [org.jetbrains.kotlin.il.generator.ILTree.overrideExDecl]
 */
abstract class ILOverrideExDecl : ILElementBase(), ILClassMember {
    ...
    abstract val implCallConv: ILCallConv
    abstract val implReturnType: ILType
    abstract val implType: ILTypeSpec
    abstract val implMethod: ILId
    abstract val implGenArity: Int
