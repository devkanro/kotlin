...
object CEE_STELEM_I8 : ILElementBase(), ILOpCode {
    override val label: String = "stelem.i8"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPopIPopI8
    ...
    override val code: UShort = 0x9Fu
