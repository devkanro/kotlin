...
object CEE_BRFALSE_S : ILElementBase(), ILOpCode {
    override val label: String = "brfalse.s"
    override val input: ILOpCodeInput = ILOpCodeInput.PopI
    override val output: ILOpCodeOutput = ILOpCodeOutput.Push0
    override val param: ILOpCodeParam = ILOpCodeParam.ShortInlineBrTarget
    override val type: ILOpCodeType = ILOpCodeType.Macro
    override val code: UShort = 0x2Cu
    override val controlFlow: ILOpCodeControlFlow = ILOpCodeControlFlow.COND_BRANCH
}
