...
object CEE_STELEM_R8 : ILElementBase(), ILOpCode {
    override val label: String = "stelem.r8"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPopIPopR8
    ...
    override val code: UShort = 0xA1u
