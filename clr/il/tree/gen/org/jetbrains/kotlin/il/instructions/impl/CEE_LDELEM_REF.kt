...
object CEE_LDELEM_REF : ILElementBase(), ILOpCode {
    override val label: String = "ldelem.ref"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPopI
    ...
    override val code: UShort = 0x9Au
