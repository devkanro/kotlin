...
import org.jetbrains.kotlin.il.primitive.ILGenParAttr
import org.jetbrains.kotlin.il.primitive.ILId
import org.jetbrains.kotlin.il.types.ILType

class ILGenParImpl @ILImplementationDetail constructor(
    override val genParAttribs: MutableList<ILGenParAttr>,
    override val genConstraints: MutableList<ILType>,
