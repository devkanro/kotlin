...
object CEE_CODE_LABEL @ILImplementationDetail constructor(
    override val code: UShort,
) : ILElementBase(), ILOpCode {
    override val label: String = "codelabel"
    ...
    override val type: ILOpCodeType = ILOpCodeType.Internal
    override val controlFlow: ILOpCodeControlFlow = ILOpCodeControlFlow.META
}
