...
object CEE_LDC_R4 : ILElementBase(), ILOpCode {
    override val label: String = "ldc.r4"
    override val input: ILOpCodeInput = ILOpCodeInput.Pop0
    override val output: ILOpCodeOutput = ILOpCodeOutput.PushR4
    override val param: ILOpCodeParam = ILOpCodeParam.ShortInlineR
    override val type: ILOpCodeType = ILOpCodeType.Primitive
    override val code: UShort = 0x22u
