...
/**
 * Generated from: [org.jetbrains.kotlin.il.generator.ILTree.dataDecl]
 */
abstract class ILDataDecl : ILElementBase(), ILMethodBodyItem {
    abstract val label: ILId
    abstract val items: MutableList<ILDataItem>
}
