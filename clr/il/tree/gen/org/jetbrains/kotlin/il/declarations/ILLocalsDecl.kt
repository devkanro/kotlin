...
/**
 * Generated from: [org.jetbrains.kotlin.il.generator.ILTree.localsDecl]
 */
abstract class ILLocalsDecl : ILElementBase(), ILMethodBodyItem {
    abstract val shouldInit: Boolean
    abstract val locals: MutableList<ILLocalDecl>
}
