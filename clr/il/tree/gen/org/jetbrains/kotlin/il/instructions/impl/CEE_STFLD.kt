...
object CEE_STFLD : ILElementBase(), ILOpCode {
    override val label: String = "stfld"
    override val input: ILOpCodeInput = ILOpCodeInput.PopRefPop1
    override val output: ILOpCodeOutput = ILOpCodeOutput.Push0
    override val param: ILOpCodeParam = ILOpCodeParam.InlineField
    override val type: ILOpCodeType = ILOpCodeType.ObjModel
    override val code: UShort = 0x7Du
