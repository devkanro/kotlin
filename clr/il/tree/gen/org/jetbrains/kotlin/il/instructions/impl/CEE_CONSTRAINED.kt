...
object CEE_CONSTRAINED : ILElementBase(), ILOpCode {
    override val label: String = "constrained."
    ...
    override val type: ILOpCodeType = ILOpCodeType.Prefix
    override val code: UShort = 0xFE16u
