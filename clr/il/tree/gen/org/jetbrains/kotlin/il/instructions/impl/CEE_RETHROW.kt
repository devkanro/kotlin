...
object CEE_RETHROW : ILElementBase(), ILOpCode {
    override val label: String = "rethrow"
    ...
    override val code: UShort = 0xFE1Au
    override val controlFlow: ILOpCodeControlFlow = ILOpCodeControlFlow.THROW
}
