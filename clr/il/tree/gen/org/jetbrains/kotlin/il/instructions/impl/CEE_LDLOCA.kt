...
object CEE_LDLOCA : ILElementBase(), ILOpCode {
    override val label: String = "ldloca"
    override val input: ILOpCodeInput = ILOpCodeInput.Pop0
    override val output: ILOpCodeOutput = ILOpCodeOutput.PushI
    override val param: ILOpCodeParam = ILOpCodeParam.InlineVar
    override val type: ILOpCodeType = ILOpCodeType.Primitive
    override val code: UShort = 0xFE0Du
