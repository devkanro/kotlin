...
object CEE_BREAK : ILElementBase(), ILOpCode {
    override val label: String = "break"
    ...
    override val code: UShort = 0x01u
    override val controlFlow: ILOpCodeControlFlow = ILOpCodeControlFlow.BREAK
}
