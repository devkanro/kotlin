...
object CEE_STIND_R4 : ILElementBase(), ILOpCode {
    override val label: String = "stind.r4"
    override val input: ILOpCodeInput = ILOpCodeInput.PopIPopR4
    ...
    override val code: UShort = 0x56u
